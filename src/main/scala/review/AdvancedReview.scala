...
object AdvancedReview extends App {
  // partial functions
  ...
  "Peter".greet  // compiler automatically does -> fromStringToPerson("Peter").greet

  // 2) implicit classes
  implicit class Dog(name: String) {
    def bark(): Unit = println("bark!")
  }
  "Lassie".bark() // compiler automatically does -> // new Dog("Lassie").bark()
